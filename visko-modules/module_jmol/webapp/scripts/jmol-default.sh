...
echo 'load ' ${infile} > ${modpath}/scripts/jmol-script-default

# executes Jmol in silent mode generating ${outfile}
java -jar ${modpath}/WEB-INF/lib/Jmol.jar -ions ${modpath}/scripts/jmol-script-default -w JPEG:${outfile} > ${modpath}/output/output.txt